...
data_dir="/home/makhataei/Projects/CallCanterQC/datasets/DushaEmotionAudio"
train_data = datasets.ImageFolder(data_dir + '/train', transform=train_transforms)
val_data = datasets.ImageFolder(data_dir + '/val', transform=train_transforms)
test_data = datasets.ImageFolder(data_dir + '/val', transform=train_transforms)
...
valloader=torch.utils.data.DataLoader(val_data, batch_size=48,shuffle=True,generator=torch.Generator(device='cuda'))
...
model.classifier = nn.Sequential(nn.Linear(1920,512),nn.LeakyReLU(),nn.Linear(512,4))
criterion = nn.CrossEntropyLoss()
OLD_Model="SER_densenet4202.pt"
NEW_Model="SER_densenet4203.pt"
...
train(2,trainloader,testloader, model, optimizer, criterion)
