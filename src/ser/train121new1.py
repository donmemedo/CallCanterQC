...
data_dir="/home/makhataei/Projects/CallCanterQC/datasets/DushaEmotionAudio/neutral"
...
model.classifier = nn.Sequential(nn.Linear(1024,512),nn.LeakyReLU(),nn.Linear(512,1))
criterion = nn.CrossEntropyLoss()
OLD_Model="SER_densenet1121.pt"
NEW_Model="SER_densenet1122.pt"
...
train(2,trainloader,valloader, model, optimizer, criterion)
